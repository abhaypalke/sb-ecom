...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(CartRepository cartRepository, AddressRepository addressRepository, PaymentRepository paymentRepository,
                            ...
                            ProductRepository productRepository, CartService cartService, ModelMapper modelMapper, AuthUtil authUtil) {
    ...
    @Override
    public OrderResponse getAllProducts(Integer pageNumber, Integer pageSize, String sortOrder, String sortBy) {
    ...
    @Override
    public OrderResponse getAllSellerOrder(Integer pageNumber, Integer pageSize, String sortOrder, String sortBy) {
        Sort sortByAndOrder = sortOrder.equalsIgnoreCase("asc")
                ? Sort.by(sortBy).ascending()
                : Sort.by(sortBy).descending();
